...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[var(--background)] text-white">
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid min-h-screen max-w-[1600px] grid-rows-[auto_1fr] px-4 pt-28 sm:px-6 sm:pt-32 lg:px-10 lg:pt-36">
          <motion.div
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-black/30 px-4 py-2 backdrop-blur-md">
              <span
          ...
          <div className="grid items-start py-12 sm:py-16 lg:grid-cols-[minmax(0,38rem)_1fr] lg:py-20">
            <motion.div
            ...
            >
              <p className="font-mono text-[10px] uppercase tracking-[0.34em] text-white/40 sm:text-[11px]">
                No visible order flow. No copied conviction.
              </p>
              <h1 className="mt-5 text-[4.35rem] font-black leading-[0.88] tracking-[-0.09em] text-white sm:text-[6.15rem] lg:text-[7.65rem] xl:text-[8.15rem]">
                DART
              </h1>
              <p className="mt-5 max-w-[21rem] text-[1.68rem] font-medium leading-[1.22] text-white/84 sm:max-w-[25rem] sm:text-[2rem] lg:max-w-[23rem] lg:text-[2.15rem]">
                Private 5-minute markets for live conviction.
              </p>
              <p className="mt-4 max-w-[28rem] text-[15px] leading-7 text-white/60 sm:text-base">
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
                <MagneticButton className="w-full sm:w-auto">
                  <button
                    ...
                    className="group flex w-full items-center justify-between gap-4 rounded-full border border-[#9ceccf]/20 bg-[#f1f4ee] px-6 py-4 text-sm font-black uppercase tracking-[0.18em] text-black transition-all hover:translate-y-[-1px] hover:shadow-[0_0_28px_rgba(241,244,238,0.22)] sm:min-w-[220px]"
                  >
                    Enter Markets
                ...
                <MagneticButton className="w-full sm:w-auto">
                  <button
                    ...
                    className="group flex w-full items-center justify-between gap-4 rounded-full border border-white/12 bg-black/28 px-6 py-4 text-sm font-bold uppercase tracking-[0.18em] text-white backdrop-blur-md transition-colors hover:bg-white/[0.08] sm:min-w-[220px]"
                  >
                    Read the Flow
