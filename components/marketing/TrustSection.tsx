                    ...
                    <div className="grid md:grid-cols-2 gap-16 max-w-4xl mx-auto text-left">
                        <div className="border-l border-white/20 pl-8">
                            ...
                            <p className="text-gray-500 leading-relaxed text-lg">
                                Your bets are recorded transparently on Sui. Every position is verifiable on-chain through DeepBook Predict smart contracts.
                            </p>
                        </div>
                        ...
                        <div className="border-l border-white/20 pl-8">
                            ...
                            <p className="text-gray-500 leading-relaxed text-lg">
                                Math doesn't lie. Sui's smart contracts ensure that payouts are calculated correctly without trusting a central authority.
                            </p>
                        </div>
                    </div>
